...
- redacted review packet is a public markdown summary over disclosed fields, loaded public context, and optional redacted comparison context; it cannot recompute the hidden snapshot hash, prove hidden receipt state, or replace a full portable receipt bundle.
