...
- Receipt risk assistant that answers cited questions about a saved live receipt after recheck, including saved-vs-current risk-driver questions.
...
- The receipt risk assistant is local and deterministic in this build; it answers only from receipt, hash, live recheck, risk-driver comparison, market, funding, and sampled account-value context.
